    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>Quản lý <b>môn học</b></h2>
                    </div>
                    <div class="col-sm-6">
                        <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i
                                class="material-icons">&#xE147;</i> <span>Thêm mới môn học</span></a>
                    </div>
                </div>
            </div>
                ...
                <form onsubmit="handleSubmitAdd(event)">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="TenMonHoc" onchange="handleChange(event)">
                        </div>
                        <div class="form-group">
                            <label>Thông tin môn học</label>
                            <input type="text" class="form-control" name="ThongTinMonHoc" onchange="handleChange(event)">
                        </div>
                        <div class="form-group">
                            <label>Khóa</label>
...
<script src="adminMonhoc.js"></script>