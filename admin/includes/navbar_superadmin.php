 ...
 <li class="nav-item">
       ...
       <div id="collapse3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
           ...
           <a class="collapse-item" href="khoa_hoc.php"> Khóa học</a>
           <a class="collapse-item" href="../admin/lich_hoc_admin.php">Lịch học</a>
           <a class="collapse-item" href="../admin/phanconglichday.php">Phân công lịch dạy</a>
           <a class="collapse-item" href="../admin/adminLopMonHoc.php">Lịch Khai giảng</a>
         </div>
       </div>
     </li>
     <!-- <li class="nav-item">
