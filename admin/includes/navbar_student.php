...
<!-- Sidebar - Brand -->
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="lop_hocst.php">
  <div class="sidebar-brand-icon rotate-n-15">
    <i class="fas fa-laugh-wink"></i>
  </div>
  <div class="sidebar-brand-text mx-3">Học Viên ITC</div>
...
<li class="nav-item active">
  <a class="nav-link" href="lop_hocst.php">
...
<li class="nav-item">
  <a class="nav-link" href="dangky_khoahoc.php">
    <i class="fa fa-check-square"></i>
