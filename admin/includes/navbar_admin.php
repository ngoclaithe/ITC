...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
  ...
  <div class="sidebar-brand-text mx-3">Giáo Vụ ITC</div>
...
<li class="nav-item">
  ...
  <div id="collapse2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="khach_hang.php">Học Viên Đăng Ký(KVL)</a>
      <a class="collapse-item" href="hoc_vien_dangkykhoahoc.php">Học Viên Đăng Ký khóa học</a>
    </div>
  </div>
</li>
