               ...
               <nav class="navigation navbar navbar-expand-md navbar-dark ">
                  ...
                  <div class="collapse navbar-collapse" id="navbarsExample04">
                     <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="giaovu_lichthi.php">Kỳ thi</a>
                        </li>
      ...
      <div class="container">
         <section class="content bgcolor-4">
            <form action="" method="post">
               <h1>THÔNG TIN KHÓA HỌC <span class="blue_light"><?php echo $p->laycot("SELECT TenKH FROM khoahoc WHERE MaKH = '$laymakh' LIMIT 1"); ?></span></h1>
