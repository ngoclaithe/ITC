   ...
   <div class="domain">
      <div class="container">
         ...
         <div class="row">
            <section>
               <!--for demo wrap-->
               <h1>Danh sách học viên lớp <span class="blue_light"><?php echo $p->laycot("SELECT TenLopHoc FROM lophoc WHERE MaLH = '$laymalh' LIMIT 1"); ?></span></h1>
               <div class="tbl-header">
                  <table cellpadding="0" cellspacing="0" border="0" style="color: blue;">
                     ...
                     <?php
                     $p->load_dshocviencualophocgiaovu("SELECT * FROM View_Danhsachhocvien WHERE MaLH = '$laymalh'");
                     ?>
                  </table>
               </div>
