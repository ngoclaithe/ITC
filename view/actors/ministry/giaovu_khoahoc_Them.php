            ...
            <section class="content bgcolor-4">
                <form action="" method="post">
                    ...
                    <span class="input input--ruri">
                        <input class="input__field input__field--ruri" placeholder="Mã Khóa Học" type="text" id="makh" name="makh" />
                        <label class="input__label input__label--ruri" for="input-26">
                        <span  id="mkh" style="color: red; float: right;"></span>
                        </label>
                    </span>
                    <span class="input input--ruri">
                        <input class="input__field input__field--ruri" placeholder="Tên khóa học" type="text" id="tenkhoahoc" name="tenkhoahoc" />
                    ...
                    <span class="input input--ruri">
                        <input class="input__field input__field--ruri" placeholder="Ngày bắt đầu" type="date" id="ngaybatdau" name="ngaybatdau" />
                        <label class="input__label input__label--ruri" for="input-26">
                        <span  id="nbd" style="color: red; float: right;"></span>
                        </label>
                    </span>
                    <span class="input input--ruri">
                        <input class="input__field input__field--ruri" placeholder="Ngày kết thúc" type="date" id="ngayketthuc" name="ngayketthuc" />
                        <label class="input__label input__label--ruri" for="input-27">
                    ...
                    <input type="submit" id="btn-basic-form" name="btn-basic-form" value="Thêm khóa học mới">
                </form>
                <?php
                switch ($_POST['btn-basic-form'] ?? null) {
                    case 'Thêm khóa học mới': {
                            $makh = $_REQUEST['makh'];
                            ...
                            if ($makh != '' && $tenkhoahoc != '' && $trangthai != '' && $ngaybatdau != '' && $ngayketthuc != '') {
                                if (($p->themxoasua("INSERT INTO khoahoc(MaKH,TenKH,NgayBD,NgayKT,Trangthai) VALUES('$makh','$tenkhoahoc','$ngaybatdau','$ngayketthuc','$trangthai')")) == 1) {
                                    echo '<script> alert("Thêm khóa học ' . $tenkhoahoc . ' thành công");</script>';
                                    header("refresh:0;url=quantrivien_khoahoc.php");
                                } else {
                                    echo '<script> alert("Thêm khóa học không thành công. Vui lòng kiểm tra lại thông tin khóa học");</script>';
                                }
                            } else {
                                echo '<script> alert("Vui lòng nhập đầy đủ thông tin khóa học");</script>';
                            }
                            break;
                        }
                }
