...
<body class="main-layout">
   ...
   <div class="domain">
      <div class="container">
         <div class="row">
         <a href="quantrivien_lichthi_Them.php" id="btn-basic">Thêm lịch mới</a>
            <section>
               <!--for demo wrap-->
               <h1>Danh sách <span class="blue_light">Lịch Thi</span></h1>
               ...
               <div class="tbl-content">
                  <?php
                  $p->load_dslichthi("SELECT * FROM lichthi");
                  ?>
               </div>
         </div>
      </div>
